...
const TextInputWithLabel = (props: {style?: any, label: string; secureTextEntry?: boolean, labelStyle:TextStyle; textInputStyle:  TextStyle; onChangeText: ((text: string) => void); focusBorderColor?: string, notFocusedBorderColor?: string}) => {
