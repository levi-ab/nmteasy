...
const ComplainQuestionModal = (props: {
  ...
  const handleSendComplaint = () => {
    userService
      ...
      .then((res) =>
        props.showToast("Помилку надіслано! Скоро її вирішимо", "success")
      )
      .catch((err) =>
        props.showToast("Щось пішло не так( Спробуй пізніше", "error")
      );
  ...
  return (
    ...
    >
      <TouchableWithoutFeedback
        onPress={() => props.setShowComplainModal(false)}
      >
